	...
	cfg := &mum_p2p.Config{
		...
		Rotator: commonconfig.NewConfigRotator(
			...
			&commonentities.OptimumConfig{
				MaxMessageSize:           cfgpkg.DefaultMaxMessageSize,
				RandomMessageSize:        uint32(cfgpkg.DefaultRandomMessageSize),
				ShardFactor:              uint32(cfgpkg.DefaultShardFactor),
				PublisherShardMultiplier: float64(cfgpkg.DefaultPublisherShardMultiplier),
				ForwardShardThreshold:    float64(cfgpkg.DefaultForwardShardThreshold),
