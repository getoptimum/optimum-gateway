...
```json
{
  ...
  "description": "Partner-facing dashboard for Optimum Gateway v1.1.1. All metrics sourced from the gateway /metrics endpoint. Select your Prometheus datasource and Network (Hoodi or Mainnet), then your gateway (by gateway_label).",
  "editable": true,
