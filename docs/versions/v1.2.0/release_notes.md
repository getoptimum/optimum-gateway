...
> **Previous release.** Partners already on v1.2.0 can remain on this version, or upgrade to [v1.3.2](../v1.3.2/release_notes.md). Partners on v1.1.1 can upgrade to v1.2.0 and remain here. Networking and CL peering are unchanged — same ports and firewall rules as v1.1.1.
