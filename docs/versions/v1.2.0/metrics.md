...
| `mump2p_stream_oldest_connection_started_seconds` | Gauge | Unix start time of the longest-running connection, `0` when none. Query as `time() - <this>`; it bounds how stale a still-honored token can be |
