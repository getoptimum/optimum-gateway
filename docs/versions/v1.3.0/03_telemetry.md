...
<details>
<summary><strong>Click to expand: Partner Dashboard JSON (v1.3.0)</strong></summary>
...
```json
{
  ...
  "description": "Partner-facing dashboard for Optimum Gateway v1.3.0. All metrics sourced from the gateway /metrics endpoint. Select your Prometheus datasource and Network (Hoodi or Mainnet), then your gateway (by gateway_label).",
  "editable": true,
  ...
  "timepicker": {},
  "timezone": "browser",
  "title": "Optimum Gateway - Partner Dashboard (v1.3.0)",
